...
public class HistorialSupervisorViewHolder extends RecyclerView.ViewHolder{
    private TextView Tipo, Titulo, Puntaje, Descripcion, Integrantes, Fecha;
    private CardView cvTipo;
    private View Divider;

    private SoftReference<itemHistorialSupervisorListener> listenerGrupo;
    public HistorialSupervisorViewHolder(@NonNull View view, SoftReference<itemHistorialSupervisorListener> listener) {
        super(view);
